function similar_text1 (first, second, percent) { // eslint-disable-line camelcase
...
function similar_text(r,t){
   return 1.0*similar_text1(r,t)/Math.max(r.length,t.length);
}
